...
})(
	{
		'2ul3k': [
			function (require, module, exports) {
				...
				module.bundle.HMR_BUNDLE_ID = '1fee8d3d694e1b7b';
				('use strict');
...
*/ var OVERLAY_ID = '__parcel__error__overlay__';
		...
		'7Slle': [
			function (require, module, exports) {
				...
				class Counter {
					title = _configJs.INITIAL_NAME;
					value = _configJs.INITIAL_VALUE;
					goal = 0;
				}
				...
				class App {
					...
					constructor() {
						...
						addCounterBtn.addEventListener(
							'click',
							this._createCounter.bind(this)
						);
					}
					_createCounter() {
					...
					_renderCounters() {
						...
						this.#counters.forEach((counter, index) => {
							...
							const counterBtns =
								counterHTML.querySelector('.counter__buttons');
							...
							counterBtns.addEventListener('click', e =>
								this._changeValue(e, counter)
							);
							// Display popup
							btnSetGoal.addEventListener('click', e => {
								if (!e.target.classList.contains('counter__button--secondary'))
									return;
					...
					_changeValue(e, counter) {
						...
						if (
							...
							counter.value > _configJs.MIN_VALUE
						)
							counter.value -= 1;
						...
						if (
							...
							counter.value < _configJs.MAX_VALUE
						)
							counter.value += 1;
						this._renderCounters();
					}
		...
		kjqCk: [
			function (require, module, exports) {
				...
				parcelHelpers.export(exports, 'INITIAL_VALUE', () => INITIAL_VALUE);
				parcelHelpers.export(exports, 'INITIAL_NAME', () => INITIAL_NAME);
				const MIN_VALUE = 0;
				const MAX_VALUE = 9999;
				const INITIAL_VALUE = 0;
				const INITIAL_NAME = 'New counter';
			},
...
//# sourceMappingURL=index.694e1b7b.js.map
